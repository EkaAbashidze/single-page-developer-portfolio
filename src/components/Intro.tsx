...
export default function intro() {
  return (
    ...
    <div className="flex flex-col items-end pt-[40px] pb-[20px]">
      <h1 className="font-grotesk-bold text-[40px] leading-[40px] max-w-[343px] tracking-[-1.14px]" >Nice to meet you! I’m Adam Keyes.</h1>
      <div className="w-[225px] h-[4px] bg-green mr-[32px]" ></div>
    </div>
      

      <p className="text-grey font-grotesk-medium font-medium text-base leading-[26px] max-w-[343px]" >Based in the UK, I’m a front-end developer passionate about building accessible web apps that users love.</p>
      

      <div className="pt-6" >

      <button className="font-grotesk-bold font-bold text-base leading -[26px] tracking-[2.28px] pb-[10px]" >CONTACT ME</button>
